    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.CharField(default='https://:4443/media/profile-pics/pfp-1.png', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rank_entry', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-rank_value'],
                'indexes': [models.Index(fields=['-rank_value'], name='backend_lad_rank_va_d72e30_idx')],
            },
        ),
    ]
